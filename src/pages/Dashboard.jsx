...
const Dashboard = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true);
    try {
      const response = await fetch('https://inventory-management-iota-gold.vercel.app/products', {
        headers: {
  ...
  const handleUpdateProduct = async (productId, updatedData) => {
    try {
      const response = await fetch(`https://inventory-management-iota-gold.vercel.app/products/${productId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleDeleteProduct = async (id) => {
    try {
      const response = await fetch(`https://inventory-management-iota-gold.vercel.app/products/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
